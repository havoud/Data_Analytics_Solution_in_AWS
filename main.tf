...
resource "aws_api_gateway_integration" "api_gateway_integration" {
  ...
  credentials             =  aws_iam_role.Data_Solution.arn
...
resource "aws_api_gateway_integration_response" "api_gateway_integration_Response" {
  ...
  resource_id = aws_api_gateway_resource.api_gateway_resource.id
  http_method = aws_api_gateway_method.api_gateway_method.http_method
  status_code = aws_api_gateway_method_response.api_gateway_response_200.status_code
  depends_on = [aws_api_gateway_method_response.api_gateway_response_200,
